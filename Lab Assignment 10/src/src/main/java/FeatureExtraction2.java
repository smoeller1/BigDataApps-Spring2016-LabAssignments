...
public class FeatureExtraction2 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            String[] classes = {"kick", "snare", "crowd", "footsteps"};
            ...
            classify(instances,new File("data/testing/footsteps/55690__robinhood76__00170-steps-on-a-forest-road-1.wav"));
    ...
    public static void sendToAndroid(String message) throws IOException {
        ...
        Socket clientSocket = new Socket("192.168.1.10", 1234);
